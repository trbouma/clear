...
_FRENCH = {
    ...
    "No active keysets": "Aucun jeu de clés actif",
...
_SPANISH = {
    ...
    "No active keysets": "No hay conjuntos de claves activos",
...
_PORTUGUESE = {
    ...
    "No active keysets": "Nenhum conjunto de chaves ativo",
...
_GERMAN = {
    ...
    "No active keysets": "Keine aktiven Schlüsselsätze",
...
_ITALIAN = {
    ...
    "No active keysets": "Nessun set di chiavi attivo",
...
_ARABIC = {
    ...
    "No active keysets": "لا توجد مجموعات مفاتيح نشطة",
